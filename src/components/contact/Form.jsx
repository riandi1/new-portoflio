  ...
  return (
    <div>
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
        Estoy disponible para discutir oportunidades de colaboración o proyectos de desarrollo.
        <br />
        <br />
      ...
      <div className="mx-2">
        <form className="flex flex-col gap-4 mt-4">
          ...
          <textarea
            placeholder="Mensaje*"
            className={`${commonClass} min-h-[100px] pt-2`}
            required
          />
